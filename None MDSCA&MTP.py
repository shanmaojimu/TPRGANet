...
from models.None_MDSCA_MTP import None_MDSCA_MTP
...
if __name__ == "__main__":
    ...
    parser.add_argument('-father_path',type=str,default='yours')

    parser.add_argument('-tensorboard_path', type=str, default='yours')
