...
from models.None_SSTG_MDSCA import None_SSTG_MDSCA
...
if __name__ == "__main__":
    ...
    parser.add_argument('-log_path', type=str, default='/home/fafu/lrq/EEG/KGAT-Mamba/log/2a消融/1,3,9/None SSTG&MDSCA',
                        help='The log files path.')
    parser.add_argument('-model_path', type=str,
                        default='/home/fafu/lrq/EEG/KGAT-Mamba/log/2a消融/1,3,9/None SSTG&MDSCA',
                        help='Path of saved model.')
    parser.add_argument('-result_path', type=str,
                        default='/home/fafu/lrq/EEG/KGAT-Mamba/log/2a消融/1,3,9/None SSTG&MDSCA', help='Path of result.')
