...
from models.None_MDSCA import None_MDSCA
...
if __name__ == "__main__":
    ...
    parser.add_argument('-log_path', type=str, default='yours', help='The log files path.')
    parser.add_argument('-model_path', type=str, default='yours', help='Path of saved model.')
    parser.add_argument('-result_path', type=str, default='yours', help='Path of result.')
    parser.add_argument('-spatial_adj_path', type=str, default='yours', help='Path of saved spatial_adj.')
    parser.add_argument('-time_adj_path', type=str, default='yours', help='Path of saved time_adj.')
