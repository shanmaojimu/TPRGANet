...
from models.TPRGANet import TPRGANet
...
if __name__ == "__main__":
    ...
    parser.add_argument('-use_adj_perturbation',type=bool,default=True,help='Whether to use adjacency matrix perturbation for data augmentation.')
    ...
    parser.add_argument('-log_path', type=str, default='/root/autodl-tmp/EEG/KGAT-Mamba/log/leaveone/HGD/8-14',
                        help='The log files path.')
    parser.add_argument('-model_path', type=str, default='/root/autodl-tmp/EEG/KGAT-Mamba/log/leaveone/HGD/8-14',
                        help='Path of saved model.')
    parser.add_argument('-result_path', type=str, default='/root/autodl-tmp/EEG/KGAT-Mamba/log/leaveone/HGD/8-14',
                        help='Path of result.')
    parser.add_argument('-spatial_adj_path', type=str, default='/root/autodl-tmp/EEG/KGAT-Mamba/log/leaveone/HGD/8-14',
                        help='Path of saved spatial_adj.')
    parser.add_argument('-time_adj_path', type=str, default='/root/autodl-tmp/EEG/KGAT-Mamba/log/leaveone/HGD/8-14',
    ...
    parser.add_argument('-father_path', type=str, default='/root/autodl-tmp/EEG/KGAT-Mamba/log/leaveone/HGD/8-14')

    parser.add_argument('-tensorboard_path', type=str, default='/root/autodl-tmp/EEG/KGAT-Mamba/log/leaveone/HGD/8-14',
