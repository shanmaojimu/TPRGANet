...
from models.None_SSTG_MDSCA_MTP import None_SSTG_MDSCA_MTP
...
if __name__ == "__main__":
    ...
    parser.add_argument('-log_path', type=str, default='/home/fafu/lrq/EEG/KGAT-Mamba/log/VR-MI消融/None3',
                        help='The log files path.')
    parser.add_argument('-model_path', type=str, default='/home/fafu/lrq/EEG/KGAT-Mamba/log/VR-MI消融/None3',
                        help='Path of saved model.')
    parser.add_argument('-result_path', type=str, default='/home/fafu/lrq/EEG/KGAT-Mamba/log/VR-MI消融/None3',
                        help='Path of result.')
    parser.add_argument('-spatial_adj_path', type=str, default='/home/fafu/lrq/EEG/KGAT-Mamba/log/VR-MI消融/None3',
                        help='Path of saved spatial_adj.')
    parser.add_argument('-time_adj_path', type=str, default='/home/fafu/lrq/EEG/KGAT-Mamba/log/VR-MI消融/None3',
    ...
    parser.add_argument('-father_path', type=str, default='/home/fafu/lrq/EEG/KGAT-Mamba/log/VR-MI消融/None3')

    parser.add_argument('-tensorboard_path', type=str, default='/home/fafu/lrq/EEG/KGAT-Mamba/log/VR-MI消融/None3',
